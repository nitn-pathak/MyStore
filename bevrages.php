...
<a href="account.html"  style="text-decoration: none; color: white;">  <img src="images/user.png" alt="" style="margin-right: 1rem; margin-top: 3rem; height: 1.7rem; width:1.7rem;">   </a>
...
<?php
        include("db.php");
        $qry =" SELECT * FROM product WHERE ptype ='bevrage';";
        ...
        <?php
            ...
            for($i=1; $i<=$row; $i++){
                ...
                for($j=1;$j<=3;$j++){           
                    ...
                    <a href="vegetable2.php?id=<?php echo $data[0]?>"  style ="text-decoration: none;">
