...
<div style="height: 40rem; width: 100rem; margin-left:15rem;  ">
      ...
      <h2 style="margin-left:22rem; margin-top: 1rem;"> Delete Product Details </h2>
...
<table class="view" style="margin-left:0rem; margin-top: 2rem; ">
    ...
    <td><input type="text" style="width: 1rem; "value="<?php echo($n[0])?>" readonly></td>
        ...
        <td> <button style="background-color: black; color: white; border-radius: .4rem; margin-left: 2rem;" ><a href="deleteproduct2.php?id=<?php echo $n[0]?>"  style ="text-decoration: none; color: white;">Delete</a></button></td>
