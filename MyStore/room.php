...
<div class="main" style="margin-top:6rem; margin-left: 9rem;"> 
 ...
 <div class="right"> 
    ...
    <img src="images/n1.jpg" alt="" style="height: 8rem; width: 8rem;; 
...
<div class="left">  
    ...
    <a href="room.php" style="margin-right: 2rem; margin-left: 13rem; text-decoration: none; color: black;"  > Profile </a>
    ...
    <a href="logout.php" style="margin-left: 2rem; text-decoration: none; color: black;"> Logout </a>
