...
<header >
  ...
  <a href="main.php" style="text-decoration: none; color: black;">  <h2 style="padding: 0; margin-right: 12rem; margin-top:3rem;">  My Store </h2> </a>
   ...
   <nav>
    ...
    <a href="Favourite.html"  style="text-decoration: none; color: white;">  <img src="images/heart.png" alt="" style="margin-right: 1rem; margin-top: 3rem; height: 1.7rem; width:1.7rem;">   </a>

    <a href="addtobag.html"  style="text-decoration: none; color: white;">  <img src="images/shopping-bag (1).png" alt="" style="margin-right: 1rem; margin-top: 3rem; height: 1.7rem; width:1.7rem;">   </a>

    <a href="delivery.html"  style="text-decoration: none; color: white;">  <img src="images/user2.png" alt="" style="margin-right: 1rem; margin-top: 3rem; height: 1.7rem; width:1.7rem;">   </a>
...
<div class="parent" style="display: flex;">
  ...
  <div style=" height: 40rem; width: 50rem;"> 
          ...
          <table style=" height: 7vh; width: 20vw;">
            ...
            <td > <a href="account.html" style="text-decoration: none; color: black;"> <h4 style="margin-left: 2rem;">Account Details</h4></td>    </a>
            ...
            <td > <a href="payment.html" style="text-decoration: none; color: black;"> <h4 style="margin-left: 2rem;"> Payment Methods</h4></td>    </a>
                ...
                <tr style="" >
                  ...
                  <td > <a href="delivery.html" style="text-decoration: none; color: black;"> <h4 style="margin-left: 2rem;">Delivery Address</h4></td>    </a>
...
<form action="delivery2.php" method="post">
      ...
      <tr><td> <input type="text"   placeholder="Email" name="email"  style="border-radius:.5rem; height: 2.7rem; width: 24rem; margin-top: 1rem;"> <br> </td> </tr>
    </td></tr>
          ...
          <input  type="text"   placeholder="Name" name="name"  style="border-radius:.5rem; height: 2.7rem; width: 24rem; margin-top: 1rem;" > <br> </td> </tr>
               
          <tr> <td> <input   type="text"   placeholder="Mobile no" name="mobile"  style="border-radius:  .5rem; height: 2.7rem; width: 24rem;  margin-top: 1rem;"> <br></td> </tr>
          ...
          <tr> <td> <input   name="landmark"  placeholder="Address" style="border-radius: .5rem; height: 2.7rem; width: 24rem;  margin-top: 1rem;" > <br></td> </tr>
          
        
       


          <tr> <td> <input     name="houseno"   placeholder="Apt,Bulding.suit"  style="border-radius: .5rem; height: 2.7rem; width: 24rem;  margin-top: 1rem;"> <br></td> </tr>
          ...
          <tr> <td style="text-align: center;"> <button class="joinbutton" onclick="check(this.form)" value="save"  style="  margin-left: 0rem;   border-radius: 5rem; height: 2.5rem; width: 10rem; background-color:black; color: white;  margin-top: 1rem;" > Save</button></td></tr>
