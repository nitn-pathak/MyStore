   ...
   <nav class="nav1" style=" margin-top: 3rem; display: flex; margin-right: 7rem;"> 
    ...
    <div class="dropdown">
      ...
      <a href="tshirt.php">Tops-T-Shirt</a>
          <a href="jerseys.php">Jerseys and Kits</a>
...
<a href="delivery.html"  style="text-decoration: none; color: white;">  <img src="images/user.png" alt="" style="margin-right: 1rem; margin-top: 3rem; height: 1.7rem; width:1.7rem;">   </a>
...
<?php
        include("db.php");
        $qry =" SELECT * FROM product WHERE ptype ='Hoodies and Sweatshirts';";
