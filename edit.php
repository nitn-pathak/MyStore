...
<tr><td> <h3> Email- <input readonly style="margin-left: 3.8rem;" type="text" placeholder="" value="<?php echo $data[2]?>  "></h3></td></tr>
...
<tr> <td>     <button style="margin-left: 16.6rem; background:black;"  ><a href="edit2.php" style= "background:black;text-decoration: none; color:white;">  Edit </a>  </button> </td> </tr>
